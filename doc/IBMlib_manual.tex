...
\begin{itemize}    
  ...
  \item {\tt interpolate\_chlorophyl(xyz, r, istat) } mg-chl/m$^3$\newline
    Chlorophyl concentration. We apply the conventional unit mg-chl/m$^3$ instead of mmol/m$^3$ for this variable.
\end{itemize}
