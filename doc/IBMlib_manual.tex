...
\title{{\Huge IBMlib} \\
       \vspace{2mm}
       {\Large A generic tool for aquatic individual-based modelling}\\
       \vspace{5mm}
...
IBMlib is a particle simulation toolbox intended for research purposes.
...
and is being prepared for online simulations (i.e. running contemporarely and coupled with 
physical circulation and ecosystem models) using variuos coupler schemes.
