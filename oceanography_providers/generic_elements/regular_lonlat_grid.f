...
c     ------ grid dimensions:   ------
      ...
      integer,public :: nx,ny,nz         ! basic grid dimensions
      real,public    :: lambda1, dlambda ! (lambda1,phi1) is the position of 
      real,public    :: phi1,    dphi    ! the first grid point (ix,iy)=(1,1)
